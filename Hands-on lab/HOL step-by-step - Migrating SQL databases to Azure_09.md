...
1. Close and re-open **Microsoft SQL Server Management Studio 17** from the Start menu, enter the following information in the **Connect to Server** dialogue and click on **Connect(6)**.
