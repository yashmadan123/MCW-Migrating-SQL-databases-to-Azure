# Exercise 3: Improve database security posture with Data Discovery and Classification and Azure Defender for SQL
...
1. Within the Azure Portal, Navigate to the SQL Managed Instance and the select the database you created as WideWorldImporters[SUFFIX].

    ![SQL MI Databases.](media/sqlmidatabaselist.png "SQL MI databases")
