...
1. On the **WideWorldImportersSUFFIX** Managed database blade, select the **Data Discovery & Classification** from the left-hand menu.
...
1. On the **Security center** blade for the `WideWorldImportersSUFFIX` Managed database, Scroll down and click on **View additional findings in Vulnerability Assessment** to open the Vulnerability Assessment blade.
