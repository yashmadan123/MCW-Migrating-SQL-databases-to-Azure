...
1. On your **sql2008-<inject key="Suffix" enableCopy="false"/>**, open Microsoft SQL Server Management Studio 19 from the Start menu, enter the following information in the **Connect to Server** dialogue and click on **Connect** **(6)**.
