...
1. Finally, in the **App Service** box, select your subscription, expand the hands-on-lab-<inject key="Suffix" /> resource group, and select the `wwi-web-UNIQUEID` Web App.
